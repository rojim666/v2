...
const SimpleAiTestPage: React.FC = () => {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      <Title level={2}>
        <RobotOutlined /> AI功能测试页面
      </Title>
      
      <Paragraph>
        这个页面用于测试百度飞桨星河社区大模型API和语音识别功能的集成效果。
      </Paragraph>
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        <Card title="📖 使用说明" size="small">
          <Space direction="vertical">
            ...
            <Text code>API Key: f3a7699d83450e93df558d40fd3c344a03156293</Text>
            <Text code>Base URL: https://aistudio.baidu.com/llm/lmapi/v3</Text>
            <Text code>默认模型: ernie-4.5-turbo-128k</Text>
...
export default SimpleAiTestPage; 